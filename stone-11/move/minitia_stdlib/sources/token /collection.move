...
module minitia_std::collection {
    ...
    public fun set_description(mutator_ref: &MutatorRef, description: String) acquires Collection {
        ...
        event::emit(
            MutationEvent { collection: mutator_ref.self , mutated_field_name: string::utf8(b"description") },
        );
    }
    ...
    public fun set_uri(mutator_ref: &MutatorRef, uri: String) acquires Collection {
        ...
        collection.uri = uri;
        event::emit(
            MutationEvent { collection: mutator_ref.self, mutated_field_name: string::utf8(b"uri") },
        );
    }
